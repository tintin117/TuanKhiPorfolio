...
style={{scaleY: scrollYProgress}}
  ...
  "  />
        ...
        <Details
              ...
              time="2014-2016"
              address=""
              work="Worked on a team responsible for creating vehicles including modeling, UV, texturing and LODs."
            />
            ...
            <Details
              ...
              time="2020- Feb 2023"
              address=""
              work="Responsible for quality control of assets, manage team, build up and develope team, training newcomers."
            />
        </ul>
      </div>
    </div>
